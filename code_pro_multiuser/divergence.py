...
第 k 层结构由 2k+1 个原始段组成：k 个同向段与 (k-1) 个反向段交替排列,
再加最末一段同向(S_last,即第 k+1 个同向段)。按"P + S(2k) + S(2k+1)"
做基础三段判定时,P 由前 2k-1 段构成,S(2k+1)=S_last。
...
"""
import numpy as np
from config import MISSED_EXTREME_MIN_BARS
